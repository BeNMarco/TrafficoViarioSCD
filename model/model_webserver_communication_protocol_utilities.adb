...
package body model_webserver_communication_protocol_utilities is
   ...
   function create_car_traiettoria_ingresso_state(id_quartiere_abitante: Positive; id_abitante: Positive; id_quartiere_urbana: Positive; id_urbana: Positive; where: Float; polo: Boolean; where_ingresso: Float; traiettoria: traiettoria_ingressi_type) return JSON_Value is
   ...
   begin
      ...
      return json;
   end create_car_traiettoria_ingresso_state;
   ...
   function create_car_urbana_state(id_quartiere_abitante: Positive; id_abitante: Positive; id_quartiere_urbana: Positive; id_urbana: Positive; where: Float; polo: Boolean; corsia: Positive) return JSON_Value is
      json: JSON_Value:= Create_Object;
   begin
      json.Set_Field("id_quartiere_abitante",id_quartiere_abitante);
      json.Set_Field("id_abitante",id_abitante);
      ...
      return json;
   end create_car_urbana_state;

   function create_car_ingresso_state(id_quartiere_abitante: Positive; id_abitante: Positive; id_quartiere_ingresso: Positive; id_ingresso: Positive; where: Float; polo: Boolean) return JSON_Value is
      json: JSON_Value:= Create_Object;
   begin
      json.Set_Field("id_quartiere_abitante",id_quartiere_abitante);
      json.Set_Field("id_abitante",id_abitante);
   ...
   function create_car_incrocio_state(id_quartiere_abitante: Positive; id_abitante: Positive; id_quartiere_incrocio: Positive; id_incrocio: Positive; where: Float; id_quartiere_urbana_ingresso: Positive; id_urbana_ingresso: Positive; direzione: traiettoria_incroci_type) return JSON_Value is
      json: JSON_Value:= Create_Object;
   begin
      json.Set_Field("id_quartiere_abitante",id_quartiere_abitante);
      json.Set_Field("id_abitante",id_abitante);
