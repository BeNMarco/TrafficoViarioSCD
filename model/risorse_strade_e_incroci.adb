      ...
      if corsia_to_go/=0 then
         ...
         if next_abitante/=null and then (next_pos_abitante=0.0 or else next_pos_abitante>next_abitante.get_posizione_abitanti_from_list_posizione_abitanti.get_where_now_posizione_abitanti+costante_additiva) then
            ...
            acceleration:= calculate_acceleration(mezzo => car,
                                                  ...
                                                  distance_to_stop_line => distance_to_stop_line+1.0,
         ...
         for h in 1..2 loop
            for i in reverse mailbox.get_ordered_ingressi_from_polo(current_polo_to_consider).all'Range loop
               ...
               if list_abitanti_uscita_andata/=null and can_move_from_traiettoria then -- se c è qualcuno da muovere e può muoversi
                  ...
                  distance_to_stop_line:= acceleration_car+get_urbana_from_id(id_task).get_lunghezza_road-(distance_ingresso+get_larghezza_corsia+get_larghezza_marciapiede)+traiettoria_rimasta_da_percorrere;
                  ...
                  mailbox.set_move_parameters_entity_on_traiettoria_ingresso(list_abitanti_uscita_andata,ingresso.get_id_road,uscita_andata,new_speed,new_step);
               ...
               if list_abitanti_uscita_ritorno/=null and can_move_from_traiettoria then
                  if list_abitanti_uscita_ritorno.get_posizione_abitanti_from_list_posizione_abitanti.get_id_abitante_posizione_abitanti=71 then
                     stop_entity:= False;
                  end if;
                  ...
                  if stop_entity=False then -- non ci sono macchine nella traiettoria entrata_ritorno quindi non deve essere data la precedenza alle macchine di quella traiettoria
                     ...
                     distance_to_stop_line:= acceleration_car+distance_ingresso-get_larghezza_marciapiede-get_larghezza_corsia+traiettoria_rimasta_da_percorrere;
                     ...
                     mailbox.set_move_parameters_entity_on_traiettoria_ingresso(list_abitanti_uscita_ritorno,ingresso.get_id_road,uscita_ritorno,new_speed,new_step);
               ...
               if list_abitanti_entrata_ritorno/=null and can_move_from_traiettoria then
                  ...
                  if stop_entity=False then
                     ...
                     distance_to_stop_line:= acceleration_car+ingresso.get_lunghezza_road+traiettoria_rimasta_da_percorrere;
                     ...
                     elsif list_abitanti_entrata_ritorno.get_posizione_abitanti_from_list_posizione_abitanti.get_where_now_posizione_abitanti<get_traiettoria_ingresso(entrata_ritorno).get_intersezioni_corsie(linea_mezzaria).get_distanza_intersezioni_corsie then
                     ...
                     elsif list_abitanti_entrata_ritorno.get_posizione_abitanti_from_list_posizione_abitanti.get_where_now_posizione_abitanti<get_traiettoria_ingresso(entrata_ritorno).get_intersezioni_corsie(linea_corsia).get_distanza_intersezioni_corsie then
                     ...
                     mailbox.set_move_parameters_entity_on_traiettoria_ingresso(list_abitanti_entrata_ritorno,ingresso.get_id_road,entrata_ritorno,new_speed,new_step);
               ...
               if list_abitanti_entrata_andata/=null and can_move_from_traiettoria then
                  ...
                  mailbox.set_move_parameters_entity_on_traiettoria_ingresso(list_abitanti_entrata_andata,ingresso.get_id_road,entrata_andata,new_speed,new_step);
         ...
         for h in 1..2 loop
            ...
            for i in 1..(mailbox.get_number_entity(road,current_polo_to_consider,1)+mailbox.get_number_entity(road,current_polo_to_consider,2)) loop
               ...
               if first_corsia/=0 then
                  if get_id_quartiere=2 and current_car_in_corsia.get_posizione_abitanti_from_list_posizione_abitanti.get_where_now_posizione_abitanti>=482.0 then
                     z:= 1;
                  end if;
                  ...
                  if destination.get_traiettoria_incrocio_to_follow/=empty or (destination.get_corsia_to_go_trajectory/=0 and destination.get_ingresso_to_go_trajectory/=0) then
                        ...
                        if current_car_in_corsia.get_posizione_abitanti_from_list_posizione_abitanti.get_in_overtaken=False then -- macchina non in sorpasso
                           ...
                           if bound_to_overtake=0.0 then -- necessario sorpassare subito
                              ...
                              if stop_entity=False and mailbox.car_on_same_corsia_have_overtaked(current_car_in_corsia,current_polo_to_consider,first_corsia) then
                                 ...
                                 distance_to_stop_line:= acceleration_car+calculate_distance_to_stop_line_from_entity_on_road(current_car_in_corsia,current_polo_to_consider,id_task);
                              ...
                              if stop_entity then  -- se la macchina non può sorpassare la si fa avanzare
                                 ...
                                 distance_to_stop_line:= acceleration_car+bound_to_overtake;
                           ...
                           if stop_entity=False and (next_car_on_road/=null and next_entity_distance/=next_car_in_ingresso_distance) then
                              acceleration:= calculate_acceleration(mezzo => car,
                                                              ...
                                                              distance_to_stop_line => distance_to_stop_line+traiettoria_rimasta_da_percorrere+1.0,
                     ...
                     if stop_entity=False then
                        ...
                        if current_car_in_corsia.get_posizione_abitanti_from_list_posizione_abitanti.get_in_overtaken=True then -- macchina in sorpasso
                           ...
                           if current_car_in_corsia.get_posizione_abitanti_from_list_posizione_abitanti.get_where_now_posizione_abitanti+new_step-bound_to_overtake<0.0 then
                     ...
                     if current_car_in_corsia.get_posizione_abitanti_from_list_posizione_abitanti.get_where_now_posizione_abitanti<get_urbana_from_id(id_task).get_lunghezza_road and current_car_in_corsia.get_posizione_abitanti_from_list_posizione_abitanti.get_where_next_posizione_abitanti=get_urbana_from_id(id_task).get_lunghezza_road then
                        ...
                        ptr_rt_incrocio(get_id_incrocio_quartiere(tratto_incrocio.get_id_quartiere_tratto,tratto_incrocio.get_id_tratto)).insert_new_car(get_id_quartiere,id_task,posizione_abitanti_on_road(current_car_in_corsia.get_posizione_abitanti_from_list_posizione_abitanti));
                     else
                        null;
                     end if;
            ...
            if list_abitanti.all.get_next_from_list_posizione_abitanti/=null then
               ...
               if distance_to_next<=0.0 then acceleration:= 0.0;
                  ...
                  acceleration:= calculate_acceleration(mezzo => car,
                                                     ...
                                                     distance_to_stop_line => acceleration_car+get_ingresso_from_id(id_task).get_lunghezza_road-current_posizione_abitante.get_where_now_posizione_abitanti+1.0,
               ...
               acceleration:= calculate_acceleration(mezzo => car,
                                                     ...
                                                     id_quartiere_abitante => current_posizione_abitante.get_id_quartiere_posizione_abitanti,
                                                     next_entity_distance => 0.0,
                                                     distance_to_stop_line => acceleration_car+get_ingresso_from_id(id_task).get_lunghezza_road-mailbox.get_car_avanzamento-current_posizione_abitante.get_where_now_posizione_abitanti+1.0,
                                                     next_id_quartiere_abitante => 0,
                                                     next_id_abitante => 0,
                                                     abitante_velocity => current_posizione_abitante.get_current_speed_abitante,
                                                     next_abitante_velocity =>0.0);
                  ...
                  if list_car.get_posizione_abitanti_from_list_posizione_abitanti.get_where_now_posizione_abitanti<length_traiettoria then
                        ...
                        if traiettoria_car=destra then
                           ...
                           if stop_entity=False then
                              if list_near_car/=null then  -- si ha una macchina davanti che è in svolta a dx
                                 ...
                                 road:= get_road_from_incrocio(id_task,calulate_index_road_to_go(id_task,i,traiettoria_car));
                                 distance_to_next_car:= ptr_rt_urbana(get_id_urbana_quartiere(road.get_id_quartiere_road_incrocio,road.get_id_strada_road_incrocio)).get_distanza_percorsa_first_abitante(not road.get_polo_road_incrocio,1);
                     ...
                     if stop_entity=False then  -- la macchina può avanzare
                        ...
                        if switch then
                           ...
                           distance_next_entity:= acceleration_car+get_larghezza_marciapiede+get_larghezza_corsia+distance_next_entity-list_car.get_posizione_abitanti_from_list_posizione_abitanti.get_where_now_posizione_abitanti;
                        end if;
                        ...
                        acceleration:= calculate_acceleration(mezzo => car,
                                                              ...
                                                              next_entity_distance => 0.0,
                                                              distance_to_stop_line => distance_next_entity+1.0,
                                                              next_id_quartiere_abitante => 0,
                                                              next_id_abitante => 0,
