...
package server_gps_utilities is
   ...
   function create_new_index_incrocio(val_id_quartiere: Natural; val_id_incrocio: Natural) return index_incroci;
   ...
   function get_id_quartiere_index_incroci(incrocio: access index_incroci) return Natural;
   function get_id_incrocio_index_incroci(incrocio: access index_incroci) return Natural;
...
private
   ...
   type tratto_percorso is tagged record
